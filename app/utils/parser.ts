 ...
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
   ...
   the License.
 */
const latex_to_js = (input: string) => {
    ...
    const square_root = (input: string) => {
    ...
    const sin = (input: string) => {

        return sinCosTanFramework("sin", input);
    };

    const tan = (input: string) => {
        return sinCosTanFramework("tan", input);
    };

    const cos = (input: string) => {
        return sinCosTanFramework("cos", input);
    };

    const sinCosTanFramework = (func: string, input: string) => {
        let pat1 = new RegExp("\\\\" + func + "\\\\left\\(([0-9a-zA-Z\\.\\+\\*\\-\\\\\\(\\)\\/]+)\\\\right\\)");
    ...
    const convert_others = (func: string, input: string) => {
